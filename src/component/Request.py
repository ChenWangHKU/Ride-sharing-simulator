...
class Request:
    ...
    def CalculatePrice(self):
        if self.cfg.ENVIRONMENT.CITY.NAME == 'Manhattan':
            initial_charge = 3.0
        ...
        elif self.cfg.ENVIRONMENT.CITY.NAME == 'Chengdu':
            initial_charge = 8.0
            mileage_charge = 1.9
            night_surcharge = 1.0 if self.send_request_timepoint > 23*3600 or self.send_request_timepoint < 6*3600 else 0.0
            total_price =  initial_charge + (self.original_travel_distance / 1000 - 2) * mileage_charge + night_surcharge
        else:
        ...
        if self.max_tol_num_person == 1:
            discount = 1.0
        elif self.max_tol_num_person == 2:
            discount = 0.8
        elif self.max_tol_num_person == 3:
            discount = 0.7
        elif self.max_tol_num_person == 4:
            discount = 0.6
        else:
            discount = 0.5
